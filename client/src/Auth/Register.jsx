  ...
  const submitRegisterForm = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://crypto-exchange-backend.vercel.app/register",
        formData,
        setHeader
      );
      const data = res.data;
                  ...
                  <div className="w-full relative">
                    ...
                    >
                      <div className="mx-auto max-w-lg ">
                        ...
                        <button
                          type="submit"
                          className="mt-5 text-lg font-semibold hover:text-white hover:bg-black bg-gray-800 
                    ...
                    <span
                      className="text-black flex items-center justify-center font-medium px-2 my-4
                        border-b border-gray-200 mobile:font-thin text-sm"
                    >
                      <Link to="/login">already registered? CLICK ME</Link>
                    </span>
                  </div>
                </div>
              </div>
